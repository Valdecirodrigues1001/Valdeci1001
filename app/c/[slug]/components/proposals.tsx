...
export default function Proposals({
  ...
  const featuredProposals = proposals.filter(
    (proposal) => proposal.is_featured
  );

  const regularProposals = proposals.filter(
    (proposal) => !proposal.is_featured
  );
  ...
  const selectedContent = selectedProposal
    ? parseProposalContent(selectedProposal.content)
    : null;
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-4xl font-black leading-tight tracking-[-0.04em] sm:text-5xl">
              Propostas para transformar ideias
              em resultados
            </h2>

            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 opacity-75">
              Conheça os principais compromissos
              desta campanha e as ações planejadas
